---
title: "Download from BOLD repository"
output:
  html_notebook:
    code_folding: show
    df_print: paged
...
**Download all insecta db using modified scripts from O'Rourke et al, 2021 Lord of the Diptera**

# 5 Arthropod except insecta
```{r}
...
# 6 Insect for non-Col/Dip/Hym/Lep orders
```{r}
gc()
