...
saveRDS(blst_global2, "./results_blastn300/blst_global2_blastn.rds")
...
median(blst_increase$global) - median(blst_increase$mydb)

# global - regional(imdb)
paste("median global-local", round(median(blst_increase$global) - median(blst_increase$imdb), 2))

# regional(imdb) - local(mydb)
paste("median global-local", round(median(blst_increase$imdb) - median(blst_increase$mydb), 2))
...
saveRDS(blst_global2, "./results_tblastx300/blst_global2_tblastx.rds")
...
blastn=readRDS("./results_blastn300/blst_global2_blastn.rds")
tblastx=readRDS("./results_tblastx300/blst_global2_tblastx.rds")
